...
| [T2](tasks/T2.md) | Test infrastructure: Testcontainers and suite layout | T1 | in_progress | — | — |
...
| [T5](tasks/T5.md) | Domain model: Amount, Accounts and the Payment state machine | T1 | in_progress | — | — |
