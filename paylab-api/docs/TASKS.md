...
| [T2](tasks/T2.md) | Test infrastructure: Testcontainers and suite layout | T1 | done | [context](task-runs/T2-CONTEXT.md) | [summary](task-runs/T2-summary.md) |
...
| Console: Wallet list and typed read contract | T16, T17 | integration, e2e, contract | T16, T17 done |
